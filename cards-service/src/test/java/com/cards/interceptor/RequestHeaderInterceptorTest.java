package com.cards.interceptor;

import com.cards.util.CorrelationIdContext;
...
public class RequestHeaderInterceptorTest {
    ...
    public void testPreHandleWithoutCorrelationId() throws Exception {
        ...
        // Depending on implementation, it might be null or previous value if not cleared.
        // But since we are in a test, it should be null if not set.
        // However, CorrelationIdContext is static ThreadLocal. We should clear it before test.
